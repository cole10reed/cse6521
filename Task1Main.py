...
#ctest_sam.exe(sam_checkpoint = 'Segment-Anything/checkpoints/sam_vit_l_0b3195.pth', model_type = 'vit_l')

# for execution on my OSC environment
# test_sam.exe(dataset_loc='')
